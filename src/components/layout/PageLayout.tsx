...
export function PageLayout({
  ...
  return (
    <div className="min-h-screen bg-stone-950">
      ...
      {/* Header — 최상단 연락처 바(62px, 연락처+언어 두 줄) 아래에 붙는다 */}
      <header className="fixed top-[62px] left-0 right-0 z-40 bg-stone-950/80 backdrop-blur-sm border-b-2 border-stone-700">
