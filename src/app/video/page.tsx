    ...
    <PageLayout title="Video">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-16 pt-8 text-center">
          <h2 className="text-2xl md:text-3xl font-semibold text-stone-200 mb-4">Video</h2>
          ...
          {videoProjects.map((video, index) => (
            ...
            >
              ...
              <a
                ...
                className="block aspect-[21/9] bg-stone-900 border-2 border-stone-700 mb-6 relative overflow-hidden group-hover:border-stone-600 transition-colors"
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-16 h-16 rounded-full border-2 border-stone-600 flex items-center justify-center group-hover:border-stone-500 transition-colors ml-1">
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                <div>
                  <h3 className="text-xl font-semibold text-stone-200 mb-2">{video.title}</h3>
